/* Analytical formula for Black-Scholes formula for Vanilla European option
 * Include analytical solution of BS:
 * - Call: Delta, gamma, vega (w.r.t volatility), rho (w.r.t time)
 * - Put: Deltam, gamma, vega, rho
 */
